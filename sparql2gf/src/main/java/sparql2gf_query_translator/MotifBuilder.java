...
public class MotifBuilder {
	...
	// transform BGP of SPARQL-query into a List of MotifPatterns and MotifFilter
	// for concrete Nodes
	...
	// TBD : FIX double-directed edges!!! transform the collected MotifPatterns in
	// SparqlToGfTranslator.class into GraphFrames motif-Format

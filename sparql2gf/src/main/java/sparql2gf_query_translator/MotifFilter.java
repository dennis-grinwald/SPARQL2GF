...
public class MotifFilter {
	...
	// these string variables are relevant ONLY for MotifFilterBuilding, therefore
	// only here present!!!
	public String vs;
	public String ep;
	public String v2o;
	...
	// FIX URI/Prefix usage!!! --- In order to add new node types (e.g. literal,uri
	// ...etc. appropriate mappings have to be added here !)
	public MotifFilter(Node s, Node p, Node o) {
		...
		/*
		 * if (!s.isConcrete()) { this.v = s.getName(); }else { this.v=s.toString();
	 ...
	 **/
	// creates MotifFilter in GraphFrame syntax : e.g. "josh(as vertex).name =
	// 'josh'" --- Fix : double naming - Prefix Mapping!!!
	public List<String> createMotifFilter() {
		...
		/*
		 * if (v!=null) { String subjectFilter = v + "." + "name=" +"'"+ vs+"'";
		 * filterList.add(subjectFilter); }
		 */
		...
		/*
		 * if (v2!=null) { String objectFilter = "object" + "." + "id=" +"'"+ v2o+"'";
